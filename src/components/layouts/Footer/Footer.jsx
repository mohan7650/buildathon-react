    ...
    <footer className={styles.footer}>
      <div className="container">
          ...
          <div className={styles.brand}>
            ...
            <a href="#top" className={styles.brandLink}>
              ...
              <div className={styles.logoGrid} aria-hidden="true">
                ...
                <span className={`${styles.square} ${styles.bright}`}></span>
                <span className={`${styles.square} ${styles.dim}`}></span>
                <span className={`${styles.square} ${styles.bright}`}></span>
            ...
            <p>
              The world's most ambitious builders, converged.
              32 hours. Multiple tracks. One stage.
              Build. Match. Ship.
            </p>
        ...
        <div className={styles.bottom}>
          ...
          <div>
            © 2026 Buildathon. Made by builders, for builders.
          </div>
